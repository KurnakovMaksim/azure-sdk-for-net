...
namespace DnsManagementClient
{
    ...
    public partial class Zone : ArmResource
    {
        ...
        public virtual async Task<Response<RecordSet>> GetRecordSetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public virtual Response<RecordSet> GetRecordSet(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
